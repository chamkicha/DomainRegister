...
<table class="table table-striped table-bordered" id="administrativeDetails-table" width="100%">
    ...
    @foreach($administrativeDetails as $administrativeDetails)
        <tr>
            ...
            <td>
                 <a href="{{ route('admin.registrantAdministrative.administrativeDetails.show', collect($administrativeDetails)->first() ) }}">
                 ...
                 <a href="{{ route('admin.registrantAdministrative.administrativeDetails.edit', collect($administrativeDetails)->first() ) }}">
                 ...
                 <a href="{{ route('admin.registrantAdministrative.administrativeDetails.confirm-delete', collect($administrativeDetails)->first() ) }}" data-toggle="modal" data-target="#delete_confirm" data-id="{{ route('admin.registrantAdministrative.administrativeDetails.delete', collect($administrativeDetails)->first() ) }}">
