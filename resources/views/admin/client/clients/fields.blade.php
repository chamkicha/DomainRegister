...
@section('content')
    ...
    <section class="content pr-3 pl-3">
        <div class="row">
            <div class="col-md-11 col-sm-11 col-lg-11 my-3" style= "display: block; margin-left: auto; margin-right: auto;">
                <div class="card " >
                    ...
                    <div class="card-body">
                        ...
                        <form id="commentForm" action="{{ route('admin.users.store') }}"
                            ...
                            <div id="rootwizard">
                                <ul>
                                    <li class="nav-item"><a href="#tab1" data-toggle="tab" class="nav-link">Registrant Details</a></li>
                                    <li class="nav-item"><a href="#tab2" data-toggle="tab" class="nav-link ml-2">Bios</a></li>
